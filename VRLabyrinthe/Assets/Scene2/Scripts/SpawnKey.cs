...
public class SpawnKey : MonoBehaviour
{
    ...
    private void Start()
    {
        _pos1 = new Vector3(Random.Range(3, 40), 2f, Random.Range(8, 30));
        _pos2 = new Vector3(Random.Range(3, 40), 2f, Random.Range(8, 30));
        _pos3 = new Vector3(Random.Range(3, 40), 2f, Random.Range(8, 30));
        _pos4 = new Vector3(Random.Range(3, 40), 2f, Random.Range(8, 30));
        _pos5 = new Vector3(Random.Range(3, 40), 2f, Random.Range(8, 30));
    ...
    private IEnumerator Spawn_Key(float duree)
    {
        ...
        _timer = false;
        StartCoroutine(Respawn_Key(60f));
    }
